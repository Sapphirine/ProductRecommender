...
def getProductInfo():
    xmlfilename=os.path.join(data_dir,'small_product_data.xml')
    productTree = ET.parse(xmlfilename)
...
def getQueryStats():
    trainFileName = os.path.join(data_dir,'psudo_train2.csv')
    ...
    output = open(os.path.join(result_dir,'top100query.txt'),'w')
...
if __name__ == "__main__":
    trainFileName = os.path.join(data_dir,'psudo_train2.csv')
    testFileName = os.path.join(data_dir,'psudo_test2.csv')
    querySkuDict, queryStat = getQuerySkuDict(trainFileName)
    ...
    """
    contentOutput = open(os.path.join(result_dir,'content.csv'),'w')
    collabOutput = open(os.path.join(result_dir,'collab.csv'),'w')
